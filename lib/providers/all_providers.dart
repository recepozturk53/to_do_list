...
final todoListProvider =
  ...
  return TodoListManager([
    ...
    TodoModel(id: const Uuid().v4(), description: 'Hamsilere Bas'),
    TodoModel(id: const Uuid().v4(), description: 'Alışveriş Yap'),
    TodoModel(id: const Uuid().v4(), description: 'Romelu Lukaku'),
  ]);
});
final filteredList = StateProvider<List<TodoModel>>((ref) {
